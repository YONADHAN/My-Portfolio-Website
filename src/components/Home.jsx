...
const Home = () => {
  return (
    <div className='container bg-gradient-to-b from-black via-black to-blue-900/95 h-screen w-full text-white relative'>
      ...
      {/* Designing portion */}
      <div data-aos="fade-up" data-aos-delay="100" className='flex flex-col justify-center items-center w-full h-[550px] lg:h-[600px]'>
        <p data-aos="slide-left" data-aos-delay="200" className='text-8xl md:text-9xl lg:text-[14rem] londrina-outline-regular top-32 md:top-56 lg:top-36 text-blue-900 relative hover:text-blue-600'>
          WEB DESIGN
        </p>
        <img data-aos="zoom-in-up" data-aos-delay="300" src="/images/YonadhanWebImage.png" alt="" className='w-[320px] h-[280px] md:w-[340px] md:h-[320px] relative bottom-5' />
        <p data-aos="slide-right" data-aos-delay="200" className='text-7xl md:text-7xl lg:text-9xl font-bold z-10 relative bottom-20 md:bottom-24 lg:bottom-16'>
          DEVELOPER
        </p>
      </div>
    </div>
