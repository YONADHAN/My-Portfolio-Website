  ...
  return (
    <div className='container w-full h-[200px] bg-black/95 flex flex-col items-center  text-white'>
      ...
      <div data-aos="zoom-up" data-aos-delay="200" className='w-[300px] flex justify-between'>
        <div><img src="/images/Linkedin.png" alt="" className='scale-50' /></div>
        <div><img src="/images/whatsapp.png" alt=""className='scale-50' /></div>
        <div><img src="/images/x.png" alt=""className='scale-50' /></div>
      </div>
    </div>
  );
}
